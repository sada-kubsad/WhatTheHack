...
```
### VMs from different VNets on different hubs can communicate: Check Propagate to Remote Route Table is checked on the vWAN > Hub > Virtual Network Connections
