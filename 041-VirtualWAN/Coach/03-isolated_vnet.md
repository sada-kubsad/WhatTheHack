...
Create two additional VNets per Hub. Also connect those Vnets to their Hubs using default routing tables. We will change the routing tables (from default routing tables) in a future step:
