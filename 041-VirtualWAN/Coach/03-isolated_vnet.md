...
<B>Note: When you create Routes tables in a vhub, it does not show up in the Portal > Route tables list nor in the resource group as a route table resource.</B> 
<B>Note: A Route Table in vHub is an allow all for the VNets the route table gets attached to</B>
